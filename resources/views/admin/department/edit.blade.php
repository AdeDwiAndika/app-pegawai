...
<div class="mx-auto">
    <div class="bg-gray-900/80 backdrop-blur-lg border border-white/10 rounded-2xl p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-white">Edit Data Departemen</h1>
                <p class="text-gray-400 mt-1">Isi form dibawah untuk mengubah data departemen</p>
            </div>
        ...
        <form action="{{ route('departments.update', $department->id) }}" method="POST" class="space-y-5">
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button type="submit"
                    class="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-900 rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all text-white inline-flex items-center gap-2">
