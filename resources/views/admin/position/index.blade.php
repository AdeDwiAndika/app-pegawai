...
@section('page-title', 'List Jabatan')
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h3 class="text-xl font-bold text-white flex items-center gap-2">
                    Daftar Jabatan
                    <span class="text-sm font-normal text-gray-400">({{ $positions->total() }} Jabatan)</span>
                </h3>
                <!-- @if(request()->filled('search'))
                <p class="text-sm text-gray-400 mt-1">
                    Hasil pencarian untuk "<span class="text-blue-400">{{ request()->input('search') }}</span>"
                    - {{ $positions->total() }} Absensi ditemukan
                </p>
                @endif -->
            </div>
        ...
        <div class="overflow-x-auto bg-gray-900/80 border border-white/10 rounded-xl shadow">
            <table class="min-w-full text-sm text-gray-300">
                <thead class="bg-gray-800/50 border-b border-white/10">
                    <tr>
                        <th class="py-3 px-4 font-medium text-gray-200">ID</th>
                        <th class="py-3 px-4 font-medium text-gray-200">Jabatan</th>
                        <th class="py-3 px-4 font-medium text-gray-200">Gaji Pokok</th>
                        <th class="py-3 px-4 font-medium text-gray-200">Aksi</th>
                    </tr>
                </thead>
