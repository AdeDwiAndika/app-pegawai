...
<div class="max-w-3xl mx-auto mt-10 bg-white border border-gray-200 rounded-[24px] w-full p-6 relative">
    <div class="flex justify-between items-start mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Detail Gaji Pegawai</h1>
            <p class="text-gray-500 w-3/4">Berikut merupakan informasi lengkap mengenai gaji pegawai</p>
        </div>
        <div class="">
        ...
        <table class="min-w-full text-sm text-left text-gray-700">
            <tbody>
                <tr class="border-b border-gray-300 ">
                    ...
                    <td class="px-6 py-3">{{ $salary->id }}</td>
                </tr>
                <tr class="border-b border-gray-300">
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <td class="px-6 py-3">Rp{{ number_format($salary->gaji_pokok, 2, ',', '.') }}</td>
                </tr>
                <tr class="border-b border-gray-300">
                    <th class="bg-green-50 px-6 py-3 font-semibold border-r border-gray-300">Tunjangan</th>
                    <td class="px-6 py-3">Rp{{ number_format($salary->tunjangan, 2, ',', '.') }}</td>
                </tr>
                <tr class="border-b border-gray-300">
                    <th class="bg-green-50 px-6 py-3 font-semibold border-r border-gray-300">Potongan</th>
                    <td class="px-6 py-3">Rp{{ number_format($salary->potongan, 2, ',', '.') }}</td>
                </tr>
                <tr>
                    <th class="bg-green-50 px-6 py-3 font-semibold rounded-bl-[16px] border-r border-gray-300">Total
                        Gaji</th>
